...
Java_com_github_dinceruur_androidfft_MainActivity_dofft(JNIEnv *env, jobject,
...
Java_com_github_dinceruur_androidfft_MainActivity_dofftdouble(JNIEnv *env, jobject,
                                                                      jdoubleArray data,
                                                                      jint is_inverse) {
...
JNIEXPORT jobjectArray JNICALL
Java_com_github_dinceruur_androidfft_DataProcess_DoFFT_dofftr(JNIEnv *env, jobject,
                                                                 jdoubleArray data) {
...
JNIEXPORT jdoubleArray JNICALL
Java_com_github_dinceruur_androidfft_MainActivity_dofftri(JNIEnv *env, jobject,
                                                                  jobjectArray data) {
